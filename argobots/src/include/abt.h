...
void ABT_read_from_pipe(int fd_fifo) ABT_API_PUBLIC;
void ABT_from_pipe_set_argo(char *buffer) ABT_API_PUBLIC;
void ABT_pipe_set_info(ABT_sched sched) ABT_API_PUBLIC;
void ABT_from_argo_get_pipe(char *write_buffer) ABT_API_PUBLIC;
void ABT_set_es() ABT_API_PUBLIC;
void ABT_set_pool(ABT_sched sched) ABT_API_PUBLIC;
